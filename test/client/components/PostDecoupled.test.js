  ...
  describe('#request type', () => {
    ...
    beforeEach(() => {
      ...
      const props = {
        ...
        personPopoverOnMouseOver: () => {}
      }
      node = mount(<Post {...{ props }} />, {
        context: { currentUser: state.people.current },
        childContextTypes: {post: object, currentUser: object}
      })
    })
