...
describe('Post', () => {
  ...
  it('visualizes cross posting between communities', () => {
    ...
    let expected = '&nbsp;in <a class="">Foomunity</a>, <a class="">Barmunity</a><div class="dropdown post-communities-dropdown"><a class="dropdown-toggle"><span> + 2 others</span></a><ul class="dropdown-menu"><li><a class="">Foomunity</a></li><li><a class="">Barmunity</a></li><li><a class="">Bazmunity</a></li><li><a class="">Quxmunity</a></li></ul><span></span></div>'
