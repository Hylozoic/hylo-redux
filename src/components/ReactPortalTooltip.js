// from https://github.com/romainberger/react-portal-tooltip
...
class Card extends React.Component {
  ...
  handleMouseEnter () {
    this.props.active && this.props.hover && this.setState({hover: true})
  }
...
export default class ReactPortalTooltip extends React.Component {
  static propTypes = {
