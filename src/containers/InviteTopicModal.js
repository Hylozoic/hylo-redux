...
export default class InviteTopicModal extends React.Component {
  static propTypes = {
    dispatch: func,
    onCancel: func,
    tagName: string,
  ...
  render () {
    ...
    return <Modal title={`Invite people to join ${tagName}`} id='share-topic'
      onCancel={onCancel}>
      <div className='join-url'>
        <label>Anyone with this link can join</label>
