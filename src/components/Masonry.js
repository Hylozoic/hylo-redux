...
// copied from https://github.com/eiriklv/react-masonry-component/blob/master/lib/index.js
// because npm hangs when attempting to install the module.
//
// changes:
// - changed require('masonry') to require('masonry-layout')
